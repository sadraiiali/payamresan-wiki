...
function SmallPrint() {
  ...
  return (
    <div className="flex flex-col items-center justify-between gap-5 border-t border-zinc-900/5 pt-8 dark:border-white/5 sm:flex-row">
      <div className="flex flex-row items-center text-xs text-zinc-600 dark:text-zinc-400">
        
        <Image src="/images/png/zan-zendegi-azadi.png" width="30" height="30" alt="زن.زندگی.آزادی" />

        <div className='inline-flex flex-row items-center justify-center gap-1 bg-slate-800 px-2'>
        
        <span className='text-white'>برای </span>

        
          <span className='iranGradient font-bold text-2xs hover:bg-green-800'>
            زن.زندگی.آزادی
          </span>
