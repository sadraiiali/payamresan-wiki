...
function SearchButton(props) {
  ...
  return (
    <>
      <button
        type="button"
        className="hidden h-8 w-full items-center gap-2 rounded-full bg-white pr-2 pl-3 text-sm text-zinc-500 ring-1 ring-zinc-900/10 transition hover:ring-zinc-900/20 dark:bg-white/5 dark:text-zinc-400 dark:ring-inset dark:ring-white/10 dark:hover:ring-white/20 lg:flex focus:[&:not(:focus-visible)]:outline-none"
        {...props}
      >
        <SearchIcon className="h-5 w-5 stroke-current" />
        جستجو کنید...
        <kbd className="mr-auto text-2xs text-zinc-400 dark:text-zinc-500">
